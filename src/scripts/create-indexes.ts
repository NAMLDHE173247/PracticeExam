...
const indexDefinitions: Array<{ collection: keyof CollectionDocumentMap; indexes: IndexDescription[] }> = [
  ...
  { collection: "user_answers", indexes: [{ key: { attemptId: 1, questionId: 1 }, name: "answers_attempt_question_unique", unique: true }, { key: { userId: 1, questionId: 1, isCorrect: 1 }, name: "answers_user_question_correct" }, { key: { userId: 1, attemptId: 1 }, name: "answers_user_attempt" }] },
